Public Class Form2
    Private Sub btnTambah_Click(sender As Object, e As EventArgs) Handles btnTambah.Click
        Try
            ...
            InsertGundam(txtKodeTambah.Text, txtNamaTambah.Text, cmbGradeTambah.Text, CInt(txtHargaTambah.Text))
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Try
            If UpdateGundam(txtKodeUpdate.Text, txtNamaUpdate.Text, cmbGradeUpdate.Text, CInt(txtHargaUpdate.Text)) Then
